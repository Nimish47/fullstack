 ...
 *      meanwhile prepareFood removed from stack
...
const cb = () => { console.log('The food is prepared!') }
const prepareFood = () => setTimeout(cb, 2000);
const placeOrder = () => { console.log('Order placed!') }
