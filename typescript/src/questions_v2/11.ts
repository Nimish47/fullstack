...
type CartState =
    | { status: "success", orderId: string, finalAmount: number }
    | { status: "paymentFailed", error: string }
    | { status: "outOfStock", productIds: number[] }

function checkout(cart: Product): CartState {
